...
class ImageManager {
    ...
    static public let types : [Beverage.Type] = [ Top.self, Georgia.self, Cantata.self,
    ...
    static func getImage(type : Beverage.Type) -> UIImage {
        guard let index = ImageManager.types.firstIndex(where: {$0 == type.self }) else { return UIImage() }
