...
class Coke: Soda {
    ...
    init(brand: String, capacity: Int, price: Int, name: String, manufacturingDate: Date, expirationDate: Date, calorie: Double, hot: Bool, zeroCalorie: Bool, strongCarbonicAcid: Bool) {
