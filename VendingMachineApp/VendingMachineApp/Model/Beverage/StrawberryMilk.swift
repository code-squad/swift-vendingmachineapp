...
class StrawberryMilk: Milk {
    ...
    init(brand: String, capacity: Double, price: Price, name: String, manufacturingDate: Date, calorie: Calorie, farmCode: FarmCode, temperature: Temperature, beverageIndex: VendingMachine.BeverageNumbers, juiceContent: Double) {
