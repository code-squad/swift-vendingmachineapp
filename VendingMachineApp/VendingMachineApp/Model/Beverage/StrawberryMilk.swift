...
class StrawberryMilk: Milk {
    ...
    init(brand: String, capacity: Int, price: Int, name: String, manufacturingDate: Date, expirationDate: Date, calorie: Double, farmCode: String, hot: Bool, juiceContent: Double) {
