...
class StrawberryMilk: Milk {
    ...
    init(brand: String, capacity: Double, price: Price, name: String, manufacturingDate: Date, calorie: Double, farmCode: FarmCode, temperature: Temperature, beverageIndex: VendingMachine.BeverageNumbers, juiceContent: Double) {
