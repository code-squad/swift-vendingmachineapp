...
class TOP: Coffee {
    ...
    init(brand: String, capacity: Int, price: Int, name: String, manufacturingDate: Date, expirationDate: Date, calorie: Double, temperature: Double, decaffeinated: Bool, beanOrigin: BeanOrigin) {
