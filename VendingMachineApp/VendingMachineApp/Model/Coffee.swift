...
class TOP: Coffee {
    override init(brand: String, volume: Int, price: Int, name: String, manufacturingDate: Date) {
        super.init(brand: "맥심", volume: 275, price: 900, name: "TOP", manufacturingDate: date)
    }
}

class Cantata: Coffee {
    override init(brand: String, volume: Int, price: Int, name: String, manufacturingDate: Date) {
        super.init(brand: "롯데칠성", volume: 275, price: 1000, name: "칸타타", manufacturingDate: date)
    }
}

class Georgia: Coffee {
    override init(brand: String, volume: Int, price: Int, name: String, manufacturingDate: Date) {
        super.init(brand: "코카콜라", volume: 240, price: 1000, name: "조지아", manufacturingDate: date)
    }
}
