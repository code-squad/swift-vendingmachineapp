...
class BeveragesTests: XCTestCase {
    ...
    let coffee = StarbucksCoffee(manufacturer: "동서식품", brand: "스타벅스", capacity: 355, price: 2700, name: "스타벅스 모카", manufacturedDate: Date(), expirationDate:  Date(), temperature: 8)
    ...
    let milk = StrawberryMilk(manufacturer: "서울우유", brand: "서울우유", capacity: 200, price: 1200, name: "딸기맛 우유", manufacturedDate: Date(), expirationDate:  Date(), temperature: 8)
