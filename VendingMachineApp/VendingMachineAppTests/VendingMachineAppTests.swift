...
class VendingMachineAppTests: XCTestCase {
    ...
    func test_자판기() {
        ...
        let strawberryMilk = StrawBerryMilk(brand: "서울우유", capacity: 300, price: 800, name: "딸기우유", manufacturedAt: Date.input("20210302"), expirationAt: Date.input("20210310"), temperature: 5, pH: 6.5, color: StrawBerryMilk.Color.red)
        let redBull = RedBull(brand: "RedBull", capacity: 250, price: 1000, name: "레드불", manufacturedAt: Date.input("20210302"), expirationAt: Date.input("20210310"), temperature: 5, taurineContent: 1000, vitaminB: 2)
        let top = TOP(brand: "동서식품", capacity: 380, price: 2000, name: "TOP", manufacturedAt: Date.input("20210222"), expirationAt: Date.input("20210301"), temperature: 65, caffeineContent: 94, flavor: TOP.Flavor.americano)
