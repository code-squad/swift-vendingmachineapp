...
class VendingMachineTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        strawberryMilk1 = denmarkStrawberryMilkFactory.createProduct(manufactured: "20210222", expiredAfter: "20210302")
        strawberryMilk2 = denmarkStrawberryMilkFactory.createProduct(manufactured: "20210201", expiredAfter: "20210302")
        strawberryMilk3 = denmarkStrawberryMilkFactory.createProduct(manufactured: "20210218", expiredAfter: "20210228")
        chocolateMilk1 = maeilChocolateMilkFactory.createProduct(manufactured: "20210222", expiredAfter: "20210302")
        chocolateMilk2 = maeilChocolateMilkFactory.createProduct(manufactured: "20210201", expiredAfter: "20210211")
        chocolateMilk3 = maeilChocolateMilkFactory.createProduct(manufactured: "20210218", expiredAfter: "20210228")
        zeroSugarCoke1 = zeroSugarCokeFactory.createProduct(manufactured: "20200101", expiredAfter: "20220101")
        zeroSugarCoke2 = zeroSugarCokeFactory.createProduct(manufactured: "20190101", expiredAfter: "20210101")
        zeroSugarCoke3 = zeroSugarCokeFactory.createProduct(manufactured: "20190301", expiredAfter: "20210301")
        ...
        redBull1 = redBullFactory.createProduct(manufactured: "20200101", expiredAfter: "20210101")
        redBull2 = redBullFactory.createProduct(manufactured: "20200601", expiredAfter: "20200601")
        redBull3 = redBullFactory.createProduct(manufactured: "20200301", expiredAfter: "20210301")
