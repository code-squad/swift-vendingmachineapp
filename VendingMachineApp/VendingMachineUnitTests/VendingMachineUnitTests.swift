...
class VendingMachineUnitTests: XCTestCase {
    ...
    let bananaMilk = BananaMilk(name: "바나나는 원래 하얗다", brand: "매일우유", servingSize: 150, price: Money(1200), manufactureDate: Date(), expirationDate: Date(timeIntervalSinceNow:86400), farmCode: "AEKS1238", bananaContentGram: 20)
    let coke = Coke(name: "코카콜라 제로", brand: "코카콜라", servingSize: 550, price: Money(3500), manufactureDate: Date(), expirationDate: Date(timeIntervalSinceNow:86400), isSugarFree: true, packageColor: "Red")
    let sprite = Sprite(name: "펩시", brand: "PEPSI", servingSize: 120, price: Money(900), manufactureDate: Date(), expirationDate: Date(timeIntervalSinceNow:86400), isSugarFree: false, packageMaterial: "PET")
    let georgia = Georgia(name: "TOP아메리카노", brand: "TOP", servingSize: 180, price: Money(1500), manufactureDate: Date(), expirationDate: Date(timeIntervalSinceNow:86400), servingCaffeine: 140, isHotCoffee: false)
    let cantata = Cantata(name: "칸타타", brand: "칸타타", servingSize: 260, price: Money(2500), manufactureDate: Date(), expirationDate: Date(timeIntervalSinceNow:86400), servingCaffeine: 240, isCoffeeLatte: true)
    ...
    func testPuttingMoneyAndBuying() {
        ...
        let bananaMilk = BananaMilk(name: "바나나는 원래 하얗다", brand: "매일우유", servingSize: 150, price: Money(1200), manufactureDate: Date(), expirationDate: Date(timeIntervalSinceNow:86400), farmCode: "AEKS38", bananaContentGram: 30)
